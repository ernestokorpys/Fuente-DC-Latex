...
Se utilizó como transistor de potencia tres 2N3055\cite{2N3055} conectados en paralelo, con ganancia $h_{FE1} =20$ y $V_{BE1(ON)} =1,5~V$ mientras que para accionarlo se utiliza un BD139 \cite{BD139} con $h_{FE4} =30$ y $V_{BE4(ON)} =1V$. \par 
...
\end{equation} \par 
El transistor Q5 es un BC559 \cite{BC559} y tiene una ganancia $hfe5=110$ y una tensión emisor-base $V_{EB5}=0,7V$ con la cual la resistencia R8 resulta:
\begin{equation}

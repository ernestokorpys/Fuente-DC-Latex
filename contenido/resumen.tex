...
\begin{resumen}{Fuente de tensión, Lazo de control, Digital, Control de Corriente, Control de Tensión.}
...
Como núcleo de control, se emplea el \entreComillas{Arduino NANO}, destacando su capacidad para gestionar eficientemente las operaciones del sistema. Es importante mencionar que este diseño no requiere de conexión inalámbrica, lo que simplifica su implementación y uso.\par

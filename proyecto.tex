...
%\input{contenido/nomenclatura}
\mainmatter

% 7. CAPÍTULOS
\input{contenido/1_introduccion.tex}
\input{contenido/2_IntroduccionTeorica.tex}
\input{contenido/3_fuente_anterior.tex}
\input{contenido/4_Actuador.tex}
\input{contenido/5_estrategia_de_control.tex}
\input{contenido/5_1_algoritmo_implementacion.tex}
\input{contenido/6_control_digital.tex}
\input{contenido/7_software_y_diseño.tex}
\input{contenido/8_construccion_pcb.tex}
\input{contenido/8_1_segundo_prototipo.tex}
\input{contenido/9_Instrucciones_uso.tex}
\input{contenido/11_Resultados_experimentales}
\input{contenido/12_conclusiones_finales.tex}
%\input{contenido/3_conclusiones}
